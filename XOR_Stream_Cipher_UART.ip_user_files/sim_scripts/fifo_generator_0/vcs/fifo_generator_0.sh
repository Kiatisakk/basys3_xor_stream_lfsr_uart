...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../XOR_Stream_Cipher_UART.srcs/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.fifo_generator_0 -o fifo_generator_0_simv
}
