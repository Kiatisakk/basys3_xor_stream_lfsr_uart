...
HD_PWD='C:/Users/USER/Desktop/Digital_Project/XOR_Stream_Cipher_UART/XOR_Stream_Cipher_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_System.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Top_System.tcl -notrace
