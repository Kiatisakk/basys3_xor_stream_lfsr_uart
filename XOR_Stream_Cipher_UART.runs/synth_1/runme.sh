...
HD_PWD='C:/Users/USER/Desktop/Digital_Project/XOR_Stream_Cipher_UART/XOR_Stream_Cipher_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_System.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Top_System.tcl
